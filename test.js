...
function drawScene(gl, programInfo, buffers, deltaTime) {
  ...
  //   0, -2 / (bottom - top), 0, 0,
  //   0, 0, 2 / (near - far), 0,
  //   (left + right) / (left - right), (top + bottom) / (bottom - top), (far + near) / (near - far), 1
  // ];
  ...
  //                [0.4, 0.4, 0.0]);  // amount to translate
  ...
  // glMatrix.mat4.scale(modelViewMatrix, modelViewMatrix, [0.5, 0.5, 0]);
